...
import (
	...
	"github.com/morzhanov/go-realworld/internal/pictures/grpc"
...
func main() {
	...
	log.Println("creating pictures service")
	...
	rpcServer := grpc.NewPicturesRpcServer(service, c, t, l)
	...
	if err := db.RunMigrations(dbs, "pictures"); err != nil {
		cancel()
	...
	l.Info("pictures service successfully started!")
	<-quit
